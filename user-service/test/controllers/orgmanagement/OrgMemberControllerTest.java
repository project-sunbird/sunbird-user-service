...
public class OrgMemberControllerTest {
  ...
  public void testAddMemberToOrgSuccess() {
    Result result = testHelper.performTest("/v1.3/org/member/add", "POST", getOrgRequest(), headerMap);
  ...
  public void testAddMemberToFailure() {
    Result result = testHelper.performTest("/v1.3/org/member/add", "GET", getOrgRequest(), headerMap);
  ...
  public void testRemoveMemberToOrgSuccess() {
    Result result = testHelper.performTest("/v1.3/org/member/remove", "POST", getOrgRequest(), headerMap);
    assertTrue(testHelper.getResponseStatus(result) == Status.OK.getStatusCode());
  ...
  public void testRemoveMemberToFailure() {
    Result result = testHelper.performTest("/v1.3/org/member/remove", "GET", getOrgRequest(), headerMap);
    assertTrue(testHelper.getResponseStatus(result) == Status.NOT_FOUND.getStatusCode());
