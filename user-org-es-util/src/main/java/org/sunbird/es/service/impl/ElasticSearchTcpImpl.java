...
public class ElasticSearchTcpImpl implements ElasticSearchService {
  ...
  public Future<String> save(String index, String identifier, Map<String, Object> data) {
    ...
    ElasticSearchHelper.logMethodStart(
        "ElasticSearchTcpImpl:save: method started at ==", startTime);
    ...
    try {
      ...
      ElasticSearchHelper.logMethodEnd("ElasticSearchTcpImpl:save: method end at ==", startTime);
      ...
      ElasticSearchHelper.logMethodEnd(
          "ElasticSearchTcpImpl:save:onException method end at ==", startTime);
      promise.success("");
    }
    return promise.future();
  }
  ...
  public Future<Map<String, Object>> getDataByIdentifier(String index, String identifier) {
    ...
    ElasticSearchHelper.logMethodStart(
        "ElasticSearchTcpImpl:getDataByIdentifier: method started at ==", startTime);
    ...
    ElasticSearchHelper.logMethodEnd(
        "ElasticSearchTcpImpl:getDataByIdentifier: method end at ==", startTime);
  ...
  public Future<Boolean> update(String index, String identifier, Map<String, Object> data) {
    ...
    if (!StringUtils.isBlank(index) && !StringUtils.isBlank(identifier) && data != null) {
      try {
        ...
        if (response.getResult().name().equals("UPDATED")) {
          ElasticSearchHelper.logMethodEnd(
              "ElasticSearchTcpImpl:update: method end successfully ==", startTime);
    ...
    ElasticSearchHelper.logMethodEnd("ElasticSearchTcpImpl:update: method end ==", startTime);
  ...
  public Future<Boolean> upsert(String index, String identifier, Map<String, Object> data) {
    ...
    if (!StringUtils.isBlank(index)
      ...
      try {
        ...
        ProjectLogger.log(
            "ElasticSearchTcpImpl:upsert: error occured == " + e.getMessage(),
            LoggerEnum.ERROR.name());
        promise.success(false);
        return promise.future();
      }
      ...
      if (ElasticSearchHelper.upsertResults.contains(response.getResult().name())) {
        ElasticSearchHelper.logMethodEnd(
            "ElasticSearchTcpImpl:upsert: method ended successfully ==", startTime);
        promise.success(true);
        return promise.future();
      }
    } else {
    ...
    ElasticSearchHelper.logMethodEnd("ElasticSearchTcpImpl:upsert: method ended ==", startTime);
    return promise.future();
  }
  ...
  public Future<Boolean> delete(String index, String identifier) {
    ...
    ElasticSearchHelper.logMethodEnd("ElasticSearchTcpImpl:delete: method end ==", startTime);
  ...
  public Future<Map<String, Object>> search(SearchDTO searchDTO, String index) {
    ...
    ElasticSearchHelper.logMethodEnd("ElasticSearchTcpImpl:search: method end ==", startTime);
  ...
  public Future<Boolean> bulkInsert(String index, List<Map<String, Object>> dataList) {
    ...
    try {
      ...
      for (Map<String, Object> map : dataList) {
        map.put(EsConstant.IDENTIFIER, map.get(EsConstant.ID));
        IndexRequest request =
            new IndexRequest(index, _DOC, (String) map.get(EsConstant.IDENTIFIER)).source(map);
    ...
    ElasticSearchHelper.logMethodEnd(
        "ElasticSearchTcpImpl:bulkInsert: method end  at ==", startTime);
    return promise.future();
  }
    ...
    try {
      indexResponse =
          ConnectionManager.getClient()
              .admin()
              .indices()
              .exists(Requests.indicesExistsRequest(EsConstant.USER_INDEX_NAME))
              .get()
              .isExists();
    } catch (Exception e) {
